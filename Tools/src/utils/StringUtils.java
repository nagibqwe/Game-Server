...
public class StringUtils {
     ...
     * @return 截取后的子字符串
     * @throws NullPointerException 如果source为null
     * @throws StringIndexOutOfBoundsException 如果beginIndex小于0,
     * 或者大于等于source.length
    ...
    public static String indexOfAfter(String source, String key) {
        ...
        if (null == key || "".equals(key)) // 因为String的indexOf方法在检索空字符串""时, 总是返回起始索引, 所以, key不能为空字符串.
        {
            return null;
        }
    ...
    public static boolean contains(String source, String containedStr) {
        ...
        return source.contains(containedStr);
    }
    ...
    public static boolean containsIgnoreCase(String source, String containedStr) {
        ...
        return source.toLowerCase().contains(containedStr.toLowerCase());
    }
