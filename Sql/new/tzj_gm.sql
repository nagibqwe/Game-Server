...
--
-- Структура таблицы `gen_table_column`
--
...
--
-- Структура таблицы `qrtz_blob_triggers`
--
...
--
-- Структура таблицы `qrtz_calendars`
--
...
--
-- Структура таблицы `qrtz_cron_triggers`
--
...
--
-- Структура таблицы `qrtz_fired_triggers`
--
...
--
-- Структура таблицы `qrtz_job_details`
--
...
--
-- Дамп данных таблицы `qrtz_locks`
--
...
--
-- Структура таблицы `qrtz_paused_trigger_grps`
--
...
--
-- Структура таблицы `qrtz_scheduler_state`
--
...
--
-- Дамп данных таблицы `qrtz_scheduler_state`
--

INSERT INTO `qrtz_scheduler_state` (`sched_name`, `instance_name`, `last_checkin_time`, `checkin_interval`) VALUES
('RuoyiScheduler', 'yames.ru1782944210441', 1783032965421, 15000);

-- --------------------------------------------------------

--
-- Структура таблицы `qrtz_simple_triggers`
--
...
--
-- Структура таблицы `qrtz_simprop_triggers`
--
...
--
-- Структура таблицы `qrtz_triggers`
--
...
--
-- Структура таблицы `sys_dict_data`
--
...
--
-- Дамп данных таблицы `sys_dict_data`
--
...
--
-- Структура таблицы `sys_dict_type`
--
...
--
-- Дамп данных таблицы `sys_dict_type`
--
...
--
-- Структура таблицы `sys_logininfor`
--
...
--
-- Дамп данных таблицы `sys_logininfor`
--

INSERT INTO `sys_logininfor` (`info_id`, `login_name`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES
(1, 'admin', '185.189.46.76', 'XX XX', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-07-02 01:17:18'),
(2, 'admin', '185.189.46.13', 'XX XX', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-07-02 23:59:51'),
(3, 'admin', '185.189.46.13', 'XX XX', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-07-03 00:00:25');
...
--
-- Структура таблицы `sys_oper_log`
--
...
--
-- Структура таблицы `sys_role_dept`
--
...
--
-- Структура таблицы `sys_role_menu`
--
...
(1, 100, 'admin', '千向', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '185.189.46.13', '2026-07-03 05:00:25', '2021-04-22 19:31:29', 'admin', '2021-04-22 19:31:29', '', '2026-07-03 00:00:25', '管理员');

-- --------------------------------------------------------

--
-- Структура таблицы `sys_user_online`
--
...
--
-- Дамп данных таблицы `sys_user_online`
--
...
('83a02d7f-97d0-43d6-b6c5-fe652b63e461', 'admin', '后台应用', '185.189.46.13', 'XX XX', 'Chrome 14', 'Windows 10', 'on_line', '2026-07-03 04:59:41', '2026-07-03 04:59:51', -60000),
('86104c34-203b-4824-bffa-9012a674a2a2', 'admin', '后台应用', '185.189.46.13', 'XX XX', 'Chrome 14', 'Windows 10', 'on_line', '2026-07-03 05:00:21', '2026-07-03 05:00:26', -60000),
('8978c395-2f20-47f8-b8ae-ed5150235d34', 'admin', '后台应用', '185.189.46.76', 'XX XX', 'Chrome 14', 'Windows 10', 'on_line', '2026-07-02 06:17:18', '2026-07-02 06:17:21', -60000),
('975c3cea-d20e-4cab-a8f1-399df9f35f84', 'admin', '后台应用', '185.189.46.76', 'XX XX', 'Chrome 14', 'Windows 10', 'on_line', '2026-07-01 11:02:52', '2026-07-02 05:49:51', -60000);

-- --------------------------------------------------------

--
-- Структура таблицы `sys_user_post`
--
...
--
-- Дамп данных таблицы `sys_user_post`
--
...
--
-- Структура таблицы `sys_user_role`
--
...
--
-- Дамп данных таблицы `sys_user_role`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='运营活动' ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='运营活动boss类型' ROW_FORMAT=COMPACT;

-- --------------------------------------------------------

--
-- Структура таблицы `t_activity_festival_relation`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='运营活动节日类型' ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='运营活动幸运值' ROW_FORMAT=COMPACT;

-- --------------------------------------------------------

--
-- Структура таблицы `t_activity_model`
--
...
CREATE TABLE `t_activity_template` (
  ...
  `isOpenServer` int(32) DEFAULT 0 COMMENT '是否是新服活动',
  `custom` text DEFAULT NULL COMMENT '自定义参数',
  `templateDec` text DEFAULT NULL COMMENT '模板描述',
  `description` varchar(200) DEFAULT NULL COMMENT '活动说明'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='运营活动模板' ROW_FORMAT=COMPACT;
...
--
-- Структура таблицы `t_ban_account`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='道具扣除' ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='评价开关' ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统开关' ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_hefu` (
  ...
  `record` longtext DEFAULT NULL COMMENT '数据量记录用于合服检查'
...
CREATE TABLE `t_role_attr` (
  ...
  `isDelete` int(32) DEFAULT NULL COMMENT '是否删除，0 ：不删除， 1： 删除',
  `actionUser` varchar(128) DEFAULT NULL COMMENT '操作者名字'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='角色属性' ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='服务器列表' ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='更新公告' ROW_FORMAT=COMPACT;

-- --------------------------------------------------------

--
-- Структура таблицы `t_white`
--
...
--
-- Индексы таблицы `gen_table`
--
ALTER TABLE `gen_table`
  ADD PRIMARY KEY (`table_id`) USING BTREE;

--
-- Индексы таблицы `gen_table_column`
--
ALTER TABLE `gen_table_column`
  ADD PRIMARY KEY (`column_id`) USING BTREE;

--
-- Индексы таблицы `qrtz_blob_triggers`
--
ALTER TABLE `qrtz_blob_triggers`
  ADD PRIMARY KEY (`sched_name`,`trigger_name`,`trigger_group`);

--
-- Индексы таблицы `qrtz_calendars`
--
ALTER TABLE `qrtz_calendars`
  ADD PRIMARY KEY (`sched_name`,`calendar_name`);

--
-- Индексы таблицы `qrtz_cron_triggers`
--
ALTER TABLE `qrtz_cron_triggers`
  ADD PRIMARY KEY (`sched_name`,`trigger_name`,`trigger_group`);

--
-- Индексы таблицы `qrtz_fired_triggers`
--
ALTER TABLE `qrtz_fired_triggers`
  ADD PRIMARY KEY (`sched_name`,`entry_id`);

--
-- Индексы таблицы `qrtz_job_details`
--
ALTER TABLE `qrtz_job_details`
  ADD PRIMARY KEY (`sched_name`,`job_name`,`job_group`);

--
-- Индексы таблицы `qrtz_locks`
--
ALTER TABLE `qrtz_locks`
  ADD PRIMARY KEY (`sched_name`,`lock_name`);

--
-- Индексы таблицы `qrtz_paused_trigger_grps`
--
ALTER TABLE `qrtz_paused_trigger_grps`
  ADD PRIMARY KEY (`sched_name`,`trigger_group`);

--
-- Индексы таблицы `qrtz_scheduler_state`
--
ALTER TABLE `qrtz_scheduler_state`
  ADD PRIMARY KEY (`sched_name`,`instance_name`);

--
-- Индексы таблицы `qrtz_simple_triggers`
--
ALTER TABLE `qrtz_simple_triggers`
  ADD PRIMARY KEY (`sched_name`,`trigger_name`,`trigger_group`);

--
-- Индексы таблицы `qrtz_simprop_triggers`
--
ALTER TABLE `qrtz_simprop_triggers`
  ADD PRIMARY KEY (`sched_name`,`trigger_name`,`trigger_group`);

--
-- Индексы таблицы `qrtz_triggers`
--
...
--
-- Индексы таблицы `sys_dept`
--
ALTER TABLE `sys_dept`
  ADD PRIMARY KEY (`dept_id`) USING BTREE;

--
-- Индексы таблицы `sys_dict_data`
--
ALTER TABLE `sys_dict_data`
  ADD PRIMARY KEY (`dict_code`) USING BTREE;

--
-- Индексы таблицы `sys_dict_type`
--
...
--
-- Индексы таблицы `sys_role_dept`
--
ALTER TABLE `sys_role_dept`
  ADD PRIMARY KEY (`role_id`,`dept_id`) USING BTREE;

--
-- Индексы таблицы `sys_role_menu`
--
...
ALTER TABLE `t_activity`
  ...
  ADD KEY `state_is_end` (`state`,`isDeleted`,`endTime`) USING BTREE,
  ADD KEY `type_is_end` (`type`,`isDeleted`,`endTime`) USING BTREE,
  ADD KEY `type_is` (`type`,`isDeleted`) USING BTREE;
...
--
-- Индексы таблицы `t_activity_model`
--
ALTER TABLE `t_activity_model`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `t_ban_account`
--
ALTER TABLE `t_ban_account`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `CON` (`con`);

--
-- Индексы таблицы `t_ban_chat`
--
ALTER TABLE `t_ban_chat`
  ADD PRIMARY KEY (`id`),
...
--
-- Индексы таблицы `t_cmd_log`
--
ALTER TABLE `t_cmd_log`
  ADD PRIMARY KEY (`id`);
...
--
-- Индексы таблицы `t_db`
--
ALTER TABLE `t_db`
  ADD PRIMARY KEY (`id`) USING BTREE,
  ADD UNIQUE KEY `serverId` (`serverId`) USING BTREE;

--
-- Индексы таблицы `t_dbbak`
--
ALTER TABLE `t_dbbak`
  ADD PRIMARY KEY (`id`) USING BTREE;
...
--
-- AUTO_INCREMENT для таблицы `gen_table`
--
ALTER TABLE `gen_table`
  MODIFY `table_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号';

--
-- AUTO_INCREMENT для таблицы `gen_table_column`
--
ALTER TABLE `gen_table_column`
  MODIFY `column_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '编号';

--
-- AUTO_INCREMENT для таблицы `sys_config`
--
ALTER TABLE `sys_config`
  MODIFY `config_id` int(5) NOT NULL AUTO_INCREMENT COMMENT '参数主键', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT для таблицы `sys_dept`
--
ALTER TABLE `sys_dept`
  MODIFY `dept_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '部门id', AUTO_INCREMENT=107;

--
-- AUTO_INCREMENT для таблицы `sys_dict_data`
--
ALTER TABLE `sys_dict_data`
  MODIFY `dict_code` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '字典编码', AUTO_INCREMENT=112;

--
-- AUTO_INCREMENT для таблицы `sys_dict_type`
--
ALTER TABLE `sys_dict_type`
  MODIFY `dict_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '字典主键', AUTO_INCREMENT=105;

--
-- AUTO_INCREMENT для таблицы `sys_job`
--
ALTER TABLE `sys_job`
  MODIFY `job_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '任务ID';

--
-- AUTO_INCREMENT для таблицы `sys_job_log`
--
ALTER TABLE `sys_job_log`
  MODIFY `job_log_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '任务日志ID';

--
-- AUTO_INCREMENT для таблицы `sys_logininfor`
--
ALTER TABLE `sys_logininfor`
  MODIFY `info_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '访问ID', AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `sys_menu`
--
ALTER TABLE `sys_menu`
  MODIFY `menu_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '菜单ID', AUTO_INCREMENT=2417;

--
-- AUTO_INCREMENT для таблицы `sys_notice`
--
ALTER TABLE `sys_notice`
  MODIFY `notice_id` int(4) NOT NULL AUTO_INCREMENT COMMENT '公告ID';

--
-- AUTO_INCREMENT для таблицы `sys_oper_log`
--
ALTER TABLE `sys_oper_log`
  MODIFY `oper_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '日志主键';

--
-- AUTO_INCREMENT для таблицы `sys_post`
--
ALTER TABLE `sys_post`
  MODIFY `post_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '岗位ID', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `sys_role`
--
ALTER TABLE `sys_role`
  MODIFY `role_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '角色ID', AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT для таблицы `t_activity_model`
--
ALTER TABLE `t_activity_model`
...
--
-- AUTO_INCREMENT для таблицы `t_ban_account`
--
ALTER TABLE `t_ban_account`
  MODIFY `id` bigint(64) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `t_ban_chat`
--
ALTER TABLE `t_ban_chat`
  MODIFY `id` bigint(64) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT для таблицы `t_cmd_log`
--
ALTER TABLE `t_cmd_log`
  MODIFY `id` int(32) NOT NULL AUTO_INCREMENT COMMENT 'id';
...
--
-- AUTO_INCREMENT для таблицы `t_db`
--
ALTER TABLE `t_db`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id';

--
-- AUTO_INCREMENT для таблицы `t_dbbak`
--
ALTER TABLE `t_dbbak`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID';
...
--
ALTER TABLE `t_gm_log`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '日志主键';

--
-- AUTO_INCREMENT для таблицы `t_hefu`
--
ALTER TABLE `t_hefu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID';
...
--
-- AUTO_INCREMENT для таблицы `t_white`
--
ALTER TABLE `t_white`
  MODIFY `id` bigint(64) NOT NULL AUTO_INCREMENT;
...
--
-- Ограничения внешнего ключа таблицы `qrtz_blob_triggers`
--
ALTER TABLE `qrtz_blob_triggers`
...
--
-- Ограничения внешнего ключа таблицы `qrtz_cron_triggers`
--
ALTER TABLE `qrtz_cron_triggers`
...
--
-- Ограничения внешнего ключа таблицы `qrtz_simple_triggers`
--
ALTER TABLE `qrtz_simple_triggers`
...
--
-- Ограничения внешнего ключа таблицы `qrtz_simprop_triggers`
--
ALTER TABLE `qrtz_simprop_triggers`
...
--
-- Ограничения внешнего ключа таблицы `qrtz_triggers`
--
ALTER TABLE `qrtz_triggers`
