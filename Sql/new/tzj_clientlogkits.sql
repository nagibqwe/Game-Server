...
CREATE TABLE `t_clientlog` (
  ...
  `playerinfo` longtext DEFAULT NULL COMMENT '玩家信息',
...
--
-- Индексы таблицы `t_clientlog`
--
ALTER TABLE `t_clientlog`
  ADD PRIMARY KEY (`uuid`,`game`),
  ADD KEY `id` (`id`);
...
--
ALTER TABLE `sys_menu`
  MODIFY `menu_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '菜单ID', AUTO_INCREMENT=2053;
...
--
-- AUTO_INCREMENT для таблицы `t_clientlog`
--
ALTER TABLE `t_clientlog`
