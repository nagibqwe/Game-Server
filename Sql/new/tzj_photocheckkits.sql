...
--
-- База данных: `tzj_photocheckkits`
--
...
--
-- Дамп данных таблицы `qrtz_cron_triggers`
--
...
--
-- Дамп данных таблицы `qrtz_job_details`
--

INSERT INTO `qrtz_job_details` (`sched_name`, `job_name`, `job_group`, `description`, `job_class_name`, `is_durable`, `is_nonconcurrent`, `is_update_data`, `requests_recovery`, `job_data`) VALUES
('RuoyiScheduler', 'TASK_CLASS_NAME5', 'DEFAULT', NULL, 'com.kits.project.monitor.job.util.QuartzDisallowConcurrentExecution', '0', '1', '0', '0', );
...
--
-- Дамп данных таблицы `qrtz_triggers`
--

INSERT INTO `qrtz_triggers` (`sched_name`, `trigger_name`, `trigger_group`, `job_name`, `job_group`, `description`, `next_fire_time`, `prev_fire_time`, `priority`, `trigger_state`, `trigger_type`, `start_time`, `end_time`, `calendar_name`, `misfire_instr`, `job_data`) VALUES
('RuoyiScheduler', 'TASK_CLASS_NAME5', 'DEFAULT', 'TASK_CLASS_NAME5', 'DEFAULT', NULL, 1627488000000, -1, 5, 'PAUSED', 'CRON', 1627442807000, 0, NULL, 2, '');
...
--
-- Структура таблицы `t_photoglobal`
--
...
--
-- Дамп данных таблицы `t_photoglobal`
--

INSERT INTO `t_photoglobal` (`keyStr`, `valueStr`) VALUES
('dayLimit', '25');
...
--
-- Индексы таблицы `t_photodata`
--
ALTER TABLE `t_photodata`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `photoID` (`photoID`) USING BTREE;

--
-- Индексы таблицы `t_photoglobal`
--
ALTER TABLE `t_photoglobal`
...
--
ALTER TABLE `sys_job`
  MODIFY `job_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '任务ID', AUTO_INCREMENT=6;
...
--
ALTER TABLE `sys_menu`
  MODIFY `menu_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '菜单ID', AUTO_INCREMENT=2064;
...
--
-- AUTO_INCREMENT для таблицы `t_photodata`
--
ALTER TABLE `t_photodata`
