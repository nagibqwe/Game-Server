...
* 升级心法
*/
public class ResUpMentalHandler extends Handler{

    private final Logger log = LogManager.getLogger(ResUpMentalHandler.class);
    ...
    public void action(RMessage mess) {
        try {
           ...
           // SkillMessage.ResUpMental messInfo = (SkillMessage.ResUpMental) mess.getData();
            if (!iosession.containsAttribute(SessionAttribute.PLAYER.getValue())) {
                return;
            }
            Player player = (Player) iosession.getAttribute(SessionAttribute.PLAYER.getValue());
           // Manager.skillManager.deal().upMental(player, messInfo);
