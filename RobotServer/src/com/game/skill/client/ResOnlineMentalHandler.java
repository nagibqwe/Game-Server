...
*上线返回心法列表
*/
public class ResOnlineMentalHandler extends Handler{

    private final Logger log = LogManager.getLogger(ResOnlineMentalHandler.class);
    ...
    public void action(RMessage mess) {
        try {
           ...
           /// SkillMessage.ResOnlineMental messInfo = (SkillMessage.ResOnlineMental) mess.getData();
