...
public class ImmortalsoulRankScript implements IRankScript {


    @Override
    public int getId() {
        return ScriptEnum.ImmortalsoulScript;
    }
    ...
    public int getRankType() {
        return RankType.Immortalsoul_RANK;
    }
    ...
    public List<RankListMessage.RankInfo.Builder> getRankInfo() {
        ...
        for (Map.Entry<Integer, Long> entry : rankMap.entrySet()) {
            ...
            Manager.rankListManager.deal().buildRankInfo(entry.getKey(), rankPlayer,
                    Manager.playerManager.isOnline(rankPlayer.getRoleId()), String.valueOf(rankPlayer.getImmortalsoulPower()), rankInfoList, rankPlayer.getImmortalsoulPower());
        }
        return rankInfoList;
    }
