...
/**
 * Created by cxl on 2021/3/3.
 */
public class SoulFightRankScript implements IRankScript {

    @Override
    public int getId() {
        return ScriptEnum.SoulFightRankScript;
    }
    ...
    public int getRankType() {
        return  RankType.SOUL_FIGHT_RANK;
    }
    ...
    public List<RankListMessage.RankInfo.Builder> getRankInfo() {
        ...
        for (Map.Entry<Integer, Long> entry : rankMap.entrySet()) {
            ...
            Manager.rankListManager.deal().buildRankInfo(entry.getKey(), rankPlayer,
                    Manager.playerManager.isOnline(rankPlayer.getRoleId()), String.valueOf(rankPlayer.getSoulFight()), rankInfoList,-1);
        }
        return rankInfoList;
    }
