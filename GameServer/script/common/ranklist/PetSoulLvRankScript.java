...
public class PetSoulLvRankScript implements IRankScript {


    @Override
    public int getId() {
        return ScriptEnum.PetSoulLvRankScript;
    }
    ...
    public int getRankType() {
        return RankType.PET_SOUL_LV_RANK;
    }
    ...
    public List<RankListMessage.RankInfo.Builder> getRankInfo() {
        ...
        for (Map.Entry<Integer, Long> entry : rankMap.entrySet()) {
            ...
            Manager.rankListManager.deal().buildRankInfo(entry.getKey(), rankPlayer,
                    Manager.playerManager.isOnline(rankPlayer.getRoleId()), String.valueOf(rankPlayer.getPetSoulLv()), rankInfoList, rankPlayer.getPetSoulLv());
        }
        return rankInfoList;
    }
