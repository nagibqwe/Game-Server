...
public class FightPowerRankScript implements IRankScript {

    @Override
    public int getId() {
        return ScriptEnum.FightPowerRankScript;
    }
    ...
    public int getRankType() {
        return RankType.FIGHT_POWER_RANK;
    }
    ...
    public List<RankListMessage.RankInfo.Builder> getRankInfo() {
        ...
        for (Map.Entry<Integer, Long> entry : rankMap.entrySet()) {
            ...
            Manager.rankListManager.deal().buildRankInfo(entry.getKey(), rankPlayer,
                    Manager.playerManager.isOnline(rankPlayer.getRoleId()), String.valueOf(rankPlayer.getFightPower()), rankInfoList,-1);
        }
        return rankInfoList;
    }
