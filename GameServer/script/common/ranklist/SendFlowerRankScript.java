...
public class SendFlowerRankScript implements IRankScript {

    @Override
    public int getId() {
        return ScriptEnum.SendFlowerRankScript;
    }
    ...
    public int getRankType() {
        return RankType.SEND_FLOWER_RANK;
    }
    ...
    public List<RankListMessage.RankInfo.Builder> getRankInfo() {
        ...
        for (Map.Entry<Integer, Long> entry : rankMap.entrySet()) {
            ...
            Manager.rankListManager.deal().buildRankInfo(entry.getKey(), rankPlayer,
                    Manager.playerManager.isOnline(rankPlayer.getRoleId()), String.valueOf(rankPlayer.getSendFlower()), rankInfoList,-1);
        }
        return rankInfoList;
    }
