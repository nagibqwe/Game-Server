 ...
 * @Date: 2021/6/8 10:27
 */
public class ShowActivityScript implements IActivityScript {

    private static final Logger logger = LogManager.getLogger(ShowActivityScript.class);
    //发送给客户端的数据
    ...
    public boolean parseCustomConfig(ActivityConfig actCfg, String customStr) {
        ...
        ShowConfig data = JsonUtils.toJavaObject(customStr, ShowConfig.class);
