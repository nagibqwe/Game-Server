 ...
 * @author zenghai
 */
public class DecHpBuff implements IScript, IBuffBehavior {
    ...
    public int action(Buff buff,Fighter source, Fighter owner) {
        ...
        MapUtils.sendBuffHp(attacker, owner, -config.getParam1());

        long min = Math.min(owner.getCurHp(), config.getParam1());
