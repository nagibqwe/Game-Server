 ...
 * @author zenghai
 */
public class DecAllHpRateBuff implements IScript, IBuffBehavior {
    ...
    public int action(Buff buff,Fighter source, Fighter owner) {
        ...
        long dec = (long) (owner.getAttribute().MaxHP() * (config.getParam1() / 10000f));
    ...
    @Override
    public int getId() {
        return ScriptEnum.DecAllHpBuff;
    }
