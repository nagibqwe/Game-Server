 ...
 * @author zenghai
 */
public class ExpBuff implements IScript, IBuffBehavior {
    ...
    public int add(Buff buff,Fighter source, Fighter target) {
        ...
        player.changeExpRate(rate + player.expRateNotHaveAtt());
    ...
    public int remove(Buff buff,Fighter owner) {
        ...
        player.changeExpRate(player.expRateNotHaveAtt() - rate);
        MapUtils.sendExpRate(player);
        return 0;
    }
