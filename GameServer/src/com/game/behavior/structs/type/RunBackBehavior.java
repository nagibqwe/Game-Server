 ...
 * @author zenghai
 */
public class RunBackBehavior extends BaseBehavior {

    private long time;

    public RunBackBehavior(IMapObject imo) {
        super(imo);
    ...
    public boolean Cancel() {
        try {
            IBehavior ib = (IBehavior) Manager.scriptManager.GetScriptClass(ScriptEnum.RunBackBehaviorCommonScript);
