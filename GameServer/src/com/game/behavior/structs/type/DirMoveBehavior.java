 ...
 * @author zenghai
 */
public class DirMoveBehavior extends BaseBehavior {

    public DirMoveBehavior(IMapObject imo) {
        super(imo);
    ...
    public boolean Cancel() {
        try {
            IBehavior ib = (IBehavior) Manager.scriptManager.GetScriptClass(ScriptEnum.DirMoveBehaviorCommonScript);
