...
public class SkillDefine {
    ...
    //技能位移类型
    // 技能造成的位移效果，0不位移，1 僵直 2击退，3击飞 4抓取
    ...
    public static final int BE_PURSUE = 4;      //被追击
    public static final int BE_DOUBLE = 5;      //被连击
    public static final int BE_CRITICAL = 6;    //被会心一击
    public static final int ATTACK = 7;         //攻击
    public static final int CRIT = 8;           //暴击
    public static final int PURSUE = 9;         //追击
    public static final int DOUBLE  = 10;       //连击
    public static final int CRITICAL_HITS = 11; //会心一击
     ...
     * 技能释放目标--主人
     */
    public static final int TARGET_OWNER = 3;
}
