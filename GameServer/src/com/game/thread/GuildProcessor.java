...
/**
 * 帮会与王府的所有消息要走的线程， 防止出现多线程处理帮会与王府的数据问题
 *
 * @author soko <xuchangming@haowan123.com>
 */
public class GuildProcessor extends CommandProcessor {

    private static final Logger LOG = LogManager.getLogger("GuildProcessor");

    public GuildProcessor() {
        super(GuildProcessor.class.getSimpleName());
    }
    /**
     * 用枚举来实现单例
     */
    private enum Singleton {
        ...
        INSTANCE;
        GuildProcessor processor;

        Singleton() {
            this.processor = new GuildProcessor();
        }

        GuildProcessor getProcessor() {
            return processor;
        }
    }
     ...
     * @return
     */
    public static GuildProcessor getInstance() {
