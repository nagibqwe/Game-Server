...
/**
 * @explain: 该日志记录玩家系统发生异常时的信息。
 * @time Created on 2020/3/26 17:12.
 * @author: tc
 */
public class tbllog_error extends BaseLogBean {
	...
	public tbllog_error(String platform, String device, long role_id, String account_name, String error_msg, String did, String game_version, String os, String os_version, String device_name, String screen, String mno, String nm, int happend_time) {
	...
	@Log(logField = "error_msg", fieldType = "varchar(100)", index = "0")
