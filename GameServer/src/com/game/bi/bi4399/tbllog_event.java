...
/**
 * @explain: 该日志记录玩家在游戏内的关键节点的事件信息。请将每一个事件按先后顺序标注在本日志标题下。
 * @time Created on 2020/3/26 16:52.
 * @author: tc
 */
public class tbllog_event extends BaseLogBean {
	...
	public tbllog_event(String platform, String device, long role_id, String account_name, int event_id, String user_ip, String did, String game_version, String os, String os_version, String device_name, String screen, String mno, String nm, int happend_time) {
	...
	@Log(logField = "event_id", fieldType = "int", index = "0")
