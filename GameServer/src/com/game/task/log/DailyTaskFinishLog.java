...
public class DailyTaskFinishLog extends TaskLogBean {

    private static final Logger logger = LogManager.getLogger("DailyTaskFinishLog");

    private int finishType;   //完成的奖励倍数
