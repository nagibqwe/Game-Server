...
public class ItemManager {
    ...
    public void loadServerLanguageConfig() {
        nameMap.clear();

        String fileName = "languageNo.properties";
        Properties numberProp = PropertiesUtil.getInstance().readProperties(fileName);

        StringBuffer sb;
        for (Entry<Object, Object> entry : numberProp.entrySet()) {
