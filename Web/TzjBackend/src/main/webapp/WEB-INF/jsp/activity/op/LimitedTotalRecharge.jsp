    ...
    <script>
        function addSaltIpGrp(obj) {
            ...
            html = '<div name="cfg1" class="input-group saltIp" style="width:100%;padding:0 0 1px 0;">' +
                ...
                '<input type="text" class="form-control" id="i_reach" name="i_reach" placeholder="例：1 （单位分）" onkeyup="value=value.replace(/\\D/g,\'\')" style="max-width:auto;">' +
...
<div class="container-fluid">
    <div id="header">
        <h3>累计充值<span class="glyphicon glyphicon-question-sign" title="${msg['jsp.activity.title6']}"
                      data-container="body" data-toggle="popover" data-placement="right"
                      data-content="${msg['jsp.activity.content6']}"></span></h3>
    </div>
