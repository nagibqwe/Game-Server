    ...
    <script>
        function addSaltIpGrp(obj) {
            ...
            html = '<div name="cfg1" class="input-group saltIp" style="width:100%;padding:0 0 1px 0;">' +
                '<label class="input-group-addon">任务类型:</label>' +
                '<input type="text" class="form-control" id="taskTypes" name="taskTypes" onkeyup="value=value.replace(/\\D/g,\'\')" style="max-width:180px;">' +
                '<label class="input-group-addon">任务目标:</label>' +
                '<input type="text" class="form-control" id="reachs" name="reachs" onkeyup="value=value.replace(/\\D/g,\'\')" style="max-width:220px;">' +
                '<label class="input-group-addon">奖励:</label>' +
                '<span class="input-group-btn" >' +
                '<button class="btn btn-info" type="button" data-toggle="tooltip" data-target="#addItemModal" title="固定奖励组" id="' + rewardAddBtn +
                ...
                '</span>' +
                // '<input type="text" class="form-control" id="rewards" name="rewards" style="max-width:390px;">' +
                '<span class="input-group-btn">' +
...
<div class="container-fluid">
    <div id="header">
        <h3>庆典任务<span class="glyphicon glyphicon-question-sign" title="${msg['jsp.activity.title12']}"
                      data-container="body" data-toggle="popover" data-placement="right"
                      data-content="${msg['jsp.activity.content12']}"></span></h3>
    </div>
            ...
            <div class="col-lg-11">
                ...
                <fieldset>
                    <div class="input-group" id="clientGroup">
                        <label class="input-group-addon">客户端展示货币ID:</label>
                        <input type="text" id="coinId" name="coinId" class="form-control" onkeyup="value=value.replace(/\D/g,'')" style="max-width:180px;" />
                    </div>
                </fieldset>
                <fieldset>
                    <div class="input-group" id="saltIpGroup">
                        <label class="input-group-addon">任务配置:</label>
