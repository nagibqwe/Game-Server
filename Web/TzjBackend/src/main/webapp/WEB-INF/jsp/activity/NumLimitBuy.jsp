     ...
     function getItem(index){
		$.ajax({
			...
			success : function(jsonData) {
				...
				$("#itemIdList"+index).html(item_option);
			}
		});
	}
    ...
    $(function() {     	   	
    	...
    	$.ajax({
			...
			success : function(jsonData) {
				...
				$("#itemIdList"+(rewardIndex-1)).html(item_option);
			}
		});
    	...
    	$("#addSubmit").click(function() {
    		if ($('#activity_add').validationEngine('validate')) {
    			...
    			if (eTime <= bTime) {
    				...
    				$("#isTemplate").val("0");
    				$.post(base + "/activity/addNumLimitBuy", $("#activity_add").serialize(), function(data, status) {
    					alert(data.msg);
    					if (data.ok) {
...
<body>
	...
	<table width="95%" height="95%" align="center">
		<tr><td valign="top"><br/>
		    ...
		    <strong>——>${msg['activity.numlimitbuy']}</strong><br/><br/>
        </td></tr>
