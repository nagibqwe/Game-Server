...
<head>
    ...
    $(function() {      	    	
    		    		...
    		    		afterShow:function() {    		    			
    		    			...
    		    			$("#add").click(function() {
    		    				if ($('#add_item').validationEngine('validate')) { //物品信息验证通过后组装物品信息为字串填到奖励物品栏中
    		    					...
    		    					var itemInfo = $("#conmulateRewardList").val();		    					
    		    					if (itemInfo != '') {
    		    						itemInfo += ";";
    		    					}		    					
    		    					itemInfo += $("#itemId").val() + "," + $("#itemNum").val();
    		    					...
    		    					//console.log(itemInfo);
    		    					$("#conmulateRewardList").val(itemInfo);
        ...
        $("#deleActivityReward").click(function() {
    		var tempItem = $("#conmulateRewardList").val();
    		if (tempItem != null && tempItem != "") {
    			var strItem = "";
    			var idx = tempItem.lastIndexOf(";");
    			if (idx > -1) {
    			...
    			$("#conmulateRewardList").val(strItem);
    		}
    	});
    	
    	$("#Activityempty").click(function() {
    		$("#conmulateRewardList").val("");
    	});
    	...
    	$("#addSubmit").click(function() {
    		if ($('#activity_add').validationEngine('validate')) {    			
    			...
    			if (eTime <= bTime) {
    				...
    				$("#isTemplate").val("0");
    				var itemPrice = 0;
    	    		var rewardList = $("#conmulateRewardList").val();
    	    		if(rewardList != ""){
    				...
    				$.post(base + "/activity/addContinuousRecharge", $("#activity_add").serialize(), function(data, status) {
    					alert(data.msg);
    					if (data.ok) {
...
<body>
	...
	<table width="95%" height="95%" align="center">
		<tr><td valign="top"><br/>
		    ...
		    <strong>——>${msg['activity.recharge.continuous']}</strong><br/><br/>
        </td></tr>
        ...
        <tr><td>       
            ...
            <table frame="box" width="95%" cellspacing="10">
                ...
                <tr align="left">
                <td colspan="4">${msg['activity.recharge.everyDayTarget']}</td>
                
                <tr align="left">                              
                <td colspan="2">${msg['activity.recharge.everyDayValue']}&nbsp;&nbsp;&nbsp;&nbsp;<input id="rechargeValue" name="rechargeValue" type="text" class="validate[required,custom[integer],min[1]]"/></td>
                </tr>
                
                <tr align="left">
                <td id="selectCondition" colspan="4"></td>
                </tr>
                
                <tr>
                <td colspan="1"><input type="button" id="addCondition" value="+"/></td>
                </tr>
                <tr align="left">
                <td colspan="4">${msg['activity.recharge.continuousTarget']}</td>
                </tr>
                <tr align="left">                              
                <td colspan="2">${msg['activity.recharge.count']}&nbsp;&nbsp;&nbsp;&nbsp;<input id="rechargeCount" name="rechargeCount" type="text" class="validate[required,custom[integer],min[1]]"/></td>
                </tr> 
                <tr align="left">                              
                <td colspan="2">${msg['activity.reward']}&nbsp;&nbsp;&nbsp;&nbsp;<input name="conmulateRewardList" id="conmulateRewardList" type="text" size="60" class="validate[required]" readonly/>
