...
<head>
    ...
    <title>${msg['activity.killboss']}</title>
    ...
    $(function() {        	   	
    	...
    	$("#activity_add").validationEngine(); //validation验证表单数据
    	...
    	$("#addSubmit").click(function() {
    		if ($('#activity_add').validationEngine('validate')) { //验证通过后才能add添加    			
    			...
    			if (eTime <= bTime) {
    				...
    				$.post(base + "/activity/addKillBoss", $("#activity_add").serialize(), function(data, status) {
    					alert(data.msg);
    					if (data.ok) {
...
<body>
	...
	<table width="95%" height="95%" align="center">
		<tr><td valign="top"><br/>
		    ...
		    <strong>——>${msg['activity.killboss']}</strong><br/><br/>
        </td></tr>
        ...
        <tr><td>       
            ...
            <table frame="box" width="95%" cellspacing="10">
                ...
                <tr align="left">
                <td colspan="4">${msg['activity.killboss.bossinfo']}<input name="bossInfo" id="bossInfo" size="60" type="text" />
                &nbsp;<font color="red">${msg['activity.killboss.bossinfo.tip']}</font>
                </td>
                </tr>
