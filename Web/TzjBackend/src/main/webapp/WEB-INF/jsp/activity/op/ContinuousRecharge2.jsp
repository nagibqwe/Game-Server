...
<div class="container-fluid">
    <div id="header">
        <h3>连续累充2(购买礼包)<span class="glyphicon glyphicon-question-sign" title="${msg['jsp.activity.title21']}"
                             data-container="body" data-toggle="popover" data-placement="right"
                             data-content="${msg['jsp.activity.content21']}"></span></h3>
    </div>
            ...
            <div class="col-lg-12">
                ...
                <fieldset>
                    <div class="input-group" id="saltIpGroup1">
                        ...
                        <select name="i_reach" class="form-control" style="color:#FF0000">
                            <option value="">--请选择充值档位--</option>
                            <option value="20101">6元直购礼包</option>
                            <option value="20102">30元直购礼包</option>
                            <option value="20103">68元直购礼包</option>
                            <option value="20104">98元直购礼包</option>
                            <option value="20105">128元直购礼包</option>
                            <option value="20106">198元直购礼包</option>
                            <option value="20107">328元直购礼包</option>
                            <option value="20108">648元直购礼包</option>
                        </select>
...
<%--                        <input type="text" class="form-control" name="i_reach" onkeyup="value=value.replace(/\\D/g,\'\')" style="max-width:200px;" placeholder="单位分">--%>
                        <button class="btn btn-info" type="button" data-toggle="tooltip" title="新增" id="addSaltIpGrpBtn6" onclick="addSaltIpGrp(this)"><span class="glyphicon glyphicon-plus"></span></button>
                        <input type="hidden" name="dayCount" value="0">
                    </div>
                </fieldset>
            </div>
