...
<head>
    ...
    <title>${msg['activity.ShareAction']}</title>
    	...
    	$("#addSubmit").click(function() {
    		...
    		if ($('#activity_add').validationEngine('validate')) {
    			...
    			if (eTime <= bTime) {
    				...
    				$.post(base + "/activity/addShareAction", $("#activity_add").serialize(), function(data, status) {
    					alert(data.msg);
    					if (data.ok) {
...
<body>
	...
	<table width="95%" height="95%" align="center">
		<tr><td valign="top"><br/>
		    ...
		    <strong>——>${msg['activity.ShareAction']}</strong><br/><br/>
        </td></tr>
