...
<script type="text/javascript">
	...
	function search(){
		isSearch = 1;
		searchData("getAccumulateRecharge");
	}
	...
	function searchData(actionType){
		...
		$.ajax({
			url : base + "/accumulateRecharge/"+actionType,
			...
			success : function(data) {
				...
				setAccumulateRechargeData(data);
			}
		});
	}
	function setAccumulateRechargeData(dataObj){
		var contentHtml = "";
		...
		contentHtml += "<td>${msg['statistic.accumulateRecharge.amount']}</td>";
		contentHtml += "<td>${msg['statistic.accumulateRecharge.userCounts']}</td>";
		contentHtml += "<td>${msg['statistic.accumulateRecharge.amountAll']}</td>";
		contentHtml += "</tr>";
		for(var key in dataObj){
			var abc = dataObj[key].substring(0,1);
			contentHtml += "<tr align='center'>";
			contentHtml += "<td>"+key+"</td>";
			contentHtml += "<td>"+dataObj[key].substring(0,dataObj[key].indexOf(","))+"</td>";
			contentHtml += "<td>"+dataObj[key].substring(dataObj[key].indexOf(",")+1)+"</td>";
			contentHtml += "</tr>";
		}
		contentHtml += "</tbody>";
		contentHtml += "</table>";
		$("#getAccumulateRechargeList").html(contentHtml);
	}
...
<body>
	<div class="container-fluid">
		...
		<ul class="nav nav-tabs" id="myTab">
			<li class="active" id="getAccumulateRechargeLi">
				<a href="#getAccumulateRechargeList" data-toggle="tab">
					${msg['statistic.accumulateRecharge.title']}
				</a>
			</li>
		</ul>
	</div>
	...
	<div class="container-fluid">
		<div class="tab-content">
			<div class="tab-pane active" id="getAccumulateRechargeList"></div>
		</div>
	</div>
