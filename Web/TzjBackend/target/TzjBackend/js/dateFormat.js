...
TimeObjectUtil = {
     ...
     */
    UnixToymdDate: function(unixTime, isFull, timeZone) {
    ...
    UnixToLocalTime: function(unixTime) {     
    	return new Date(parseInt(unixTime) * 1000).toLocaleString().replace(/:\d{1,2}$/,' ');     
    },
    UnixToHIS: function(unixTime) {
    	var u = new Date(unixTime*1000);
		var date=(u.getHours()<10?"0":"")+u.getHours()+":"+(u.getMinutes()<10?"0":"")+u.getMinutes()+":"+(u.getSeconds()<10?"0":"")+u.getSeconds();
		return date;
    }
};