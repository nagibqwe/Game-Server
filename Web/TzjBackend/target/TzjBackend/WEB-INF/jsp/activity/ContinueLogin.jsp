...
<head>
    ...
    <title>${msg['activity.continueLogin']}</title>
    	...
    	$("#addSubmit").click(function() {
    		...
    		if ($('#activity_add').validationEngine('validate')) {
    			...
    			if (eTime <= bTime) {
    				...
    				$.post(base + "/activity/addContinueLogin", $("#activity_add").serialize(), function(data, status) {
    					alert(data.msg);
    					if (data.ok) {
...
<body>
	...
	<table width="95%" height="95%" align="center">
		<tr><td valign="top"><br/>
		    ...
		    <strong>——>${msg['activity.continueLogin']}</strong><br/><br/>
        </td></tr>
