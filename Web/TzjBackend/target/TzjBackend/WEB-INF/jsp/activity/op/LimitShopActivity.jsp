    ...
    <script>
        ...
        function addSaltIpGrp(obj) {
            ...
            html = '<div name="cfg1" class="input-group saltIp" style="width:100%;padding:0 0 1px 0;">' +
                ...
                '<input type="text" class="form-control" id="i_id" name="i_id" onkeyup="value=value.replace(/\\D/g,\'\')" style="max-width:80px;">' +
                ...
                '<input type="text" class="form-control" id="i_limit" name="i_limit" onkeyup="value=value.replace(/\\D/g,\'\')" style="max-width:80px;">' +
                '<label class="input-group-addon">全服限购数量:</label>' +
                '<input type="text" class="form-control" id="i_server_limit" name="i_server_limit" onkeyup="value=value.replace(/\\D/g,\'\')" style="max-width:80px;">' +
                '<label class="input-group-addon">礼包折扣:</label>' +
                '<input type="text" class="form-control" id="i_discount" name="i_discount" onkeyup="value=value.replace(/[^\\d.]/g,\'\')" style="max-width:80px;">' +
...
<div class="container-fluid">
    <div id="header">
        <h3>限时商城<span class="glyphicon glyphicon-question-sign" title="${msg['jsp.activity.title16']}"
                      data-container="body" data-toggle="popover" data-placement="right"
                      data-content="${msg['jsp.activity.content16']}"></span></h3>
    </div>
    ...
    <form id="activity_form" method="post" class="main form-horizontal" action="#">
        ...
        <div class="col-lg-14 col-sm-14 col-md-14">
