    	...
    	$("#addSubmit").click(function() {
    		if ($('#activity_add').validationEngine('validate')) {    			
    			...
    			if (eTime <= bTime) {
    				...
    				$.post(base + "/activity/addCrossServerRank", $("#activity_add").serialize(), function(data, status) {
    					alert(data.msg);
    					if (data.ok) {
...
<body>
	...
	<table width="95%" height="95%" align="center">
		<tr><td valign="top"><br/>
		    ...
		    <strong>——>${msg['activity.recharge.crossServiceRank']}</strong><br/><br/>
        </td></tr>
        ...
        <tr><td>       
            ...
            <table frame="box" width="95%" cellspacing="10">
                ...
                <tr align="left">                
                <td colspan="1">${msg['activity.recharge.rankStyle']}&nbsp;&nbsp;&nbsp;<select id="rankStyle" name="rankStyle" class="validate[required]">
                <option value="${recharge}">${msg['activity.recharge.recharge']}</option><option value="${consume}">${msg['activity.recharge.consume']}</option></select></td>
                </tr>
                ...
                <tr align="left">                
                <td colspan="1">${msg['activity.di.startTime']}<input name="dayStartTime" id="dayStartTime" type="text" class="datetimepicker validate[required]" readonly/></td>
                <td colspan="1">${msg['activity.di.endtime']}<input name="dayEndTime" id="dayEndTime" type="text" class="datetimepicker validate[required]" readonly/></td>     
                </tr>
