    	...
    	$("#addSubmit").click(function() {
    		...
    		if ($('#activity_add').validationEngine('validate')) {
    			...
    			if (eTime <= bTime) {
    				...
    				$.post(base + "/activity/addLoopRecharge", $("#activity_add").serialize(), function(data, status) {
    					alert(data.msg);
    					if (data.ok) {
...
<body>
	...
	<table width="95%" height="95%" align="center">
		<tr><td valign="top"><br/>
		    ...
		    <strong>——>${msg['activity.recharge']}:${msg['activity.recharge.loop']}</strong><br/><br/>
        </td></tr>
        ...
        <tr><td>       
            ...
            <table frame="box" width="95%" cellspacing="10">
                ...
                <tr align="left">
                <td colspan="1">${msg['activity.loop.type']}&nbsp;&nbsp;&nbsp;&nbsp;<select id="loopType" name="loopType" class="validate[required]"><option value="1">${msg['activity.loop.day']}</option><option value="2">${msg['activity.loop.week']}</option><option value="3">${msg['activity.loop.month']}</option></select></td>
                </tr>
