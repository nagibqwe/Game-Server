...
<head>
    ...
    <title>${msg['activity.addDaySend']}</title>
    	...
    	$("#addSubmit").click(function() {
    		if ($('#activity_add').validationEngine('validate')) {
    			...
    			if (eTime <= bTime) {
    				...
    				$.post(base + "/activity/addDaySend", $("#activity_add").serialize(), function(data, status) {
    					alert(data.msg);
    					if (data.ok) {
...
<body>
	...
	<table width="95%" height="95%" align="center">
		<tr><td valign="top"><br/>
		    ...
		    <strong>——>${msg['activity.daySend']}</strong><br/><br/>
        </td></tr>
        ...
        <tr><td>       
            ...
            <table frame="box" width="95%" cellspacing="10">
                ...
                <tr align="left">   
                <td>${msg['activity.sendReceive.itemId']}<input name='giftItemId' id='giftItemId' type='text' list='giftItemIdList' class='validate[required]'/><datalist id='giftItemIdList'></datalist></td>                
