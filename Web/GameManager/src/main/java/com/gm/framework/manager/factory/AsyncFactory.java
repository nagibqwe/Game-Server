package com.gm.framework.manager.factory;
...
import com.gm.common.utils.AddressUtils;
import com.gm.common.utils.LogUtils;
import com.gm.common.utils.ServletUtils;
...
import com.gm.project.monitor.logininfor.service.LogininforServiceImpl;
import com.gm.project.monitor.online.domain.OnlineSession;
...
public class AsyncFactory
{
     ...
     * GM后台自定义日志记录
     *
     * @param gmlog GM后台日志信息
     * @return 任务task
     */
    public static TimerTask recordGMLog(final GMLog gmlog)
    {
        return new TimerTask()
        {
            @Override
            ...
            {
                // 远程查询操作地点
//                gmlog.setLocation(AddressUtils.getRealAddressByIP(gmlog.getIp()));
                SpringUtils.getBean(IGMLogService.class).insertGMLog(gmlog);
            }
        };
    }
