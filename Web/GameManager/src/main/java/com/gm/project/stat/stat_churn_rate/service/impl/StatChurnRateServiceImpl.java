...
public class StatChurnRateServiceImpl implements IStatChurnRateService
{
    ...
    public void StatChurnRateCommon(List<PlayerLeaveCountBean> dataList,Set<String> vipUserIdList,Set<String> ordUserIdList,String groupName, String selectServerIdList, String channelNames,String startDate, String endDate,String select_condition,String minPay, String maxPay) throws ParseException {
       ...
       // List<Map<String, Object>> rechargeDataMap = new ArrayList<>();
        ...
        for (Date d : dateList) {
            ...
            /*
             * 分别获取统计日的登录玩家和№二День未登录且到截止日都未登录的玩家
             */
            ...
            Set<String> needVipUserIdList = new HashSet<>();//存放付费ID пользователя
            ...
            if(dataList!=null){
                ...
                firstLoginUserIdList.removeAll(lastLoginUserIdList);//№二День到截止日登录过的玩家
                ...
                lastVipUserIdList.retainAll(firstLoginUserIdList);//№二День到截止日登陆过的付费玩家
            ...
            if(vipUserIdList != null && ordUserIdList!=null){
                ...
                needVipUserIdList.retainAll(lastLoginUserIdList);//№二День到截止Дата登录过的玩家
                lastVipUserIdList.removeAll(needVipUserIdList);//№二День到截止Дата登录过的付费玩家
    ...
    public List<PlayerLeaveAmountBean> playerLeaveAmount(String selectGroupName, String selectServerIdList, String channelNames, String startDate, String endDate, Boolean  isblack,
        ...
        String vipUserId = vipUsers;//Сохранить付费流失用户
    ...
    public List<PlayerLeaveRankBean> playerLeaveRank(String selectGroupName, String selectServerIdList, String channelNames, String startDate, String endDate, Boolean  isblack,
        ...
        Map<String, Integer> ordcMap = new LinkedHashMap<>();//统计普通用户УровеньДанные
        Map<String, Integer> vipcMap = new LinkedHashMap<>();//统计付费用户УровеньДанные
        ...
        Map<Integer, Integer> ordMap = new LinkedHashMap<>();//统计Уровень对应用户数
        Map<Integer, Integer> vipMap = new LinkedHashMap<>();//统计Уровень对应付费用户数
//            for (int i = 1; i <= 800; i++) {
//                ordMap.put(i, 0);
//                vipMap.put(i, 0);
//            }

        Map<Integer, PlayerLeaveRankBean> dataMap = new LinkedHashMap<>();//统计Уровень对应用户数
