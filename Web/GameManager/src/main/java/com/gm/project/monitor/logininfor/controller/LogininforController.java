package com.gm.project.monitor.logininfor.controller;
...
import com.gm.project.monitor.logininfor.service.ILogininforService;
...
public class LogininforController extends BaseController
{
    ...
    public AjaxResult export(Logininfor logininfor)
    {
        ...
        return util.exportExcel(list, "Журнал входов");
    }
