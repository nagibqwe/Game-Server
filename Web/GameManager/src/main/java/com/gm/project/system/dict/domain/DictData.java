...
/**
 * Данные справочника表 sys_dict_data
 * 
 * @author ruoyi
 */
public class DictData extends BaseEntity
{
    ...
    /** 字典Сортировка */
    @Excel(name = "字典Сортировка", cellType = ColumnType.NUMERIC)
    ...
    /** ДаНет默认（YДа NНет） */
    @Excel(name = "ДаНет默认", readConverterExp = "Y=Да,N=Нет")
    ...
    @Size(min = 0, max = 100, message = "Тип справочника长度不能超过100个字符")
