package com.gm.project.stat.stat_recharge_counts.controller;
 ...
 */
@Controller
@RequestMapping("/stat/stat_recharge_counts")
public class StatRechargeCountsController extends BaseController
{
    private String prefix = "stat/stat_recharge_counts";

    @Autowired
    private IStatRechargeCountsService statRechargeCountsService;
    /**
     * 跳转到付费次数统计界面
     * @return
     */
    @GetMapping("/to_stat_recharge_counts")
    public String toStatRechargeCounts()
    {
        return prefix + "/stat_recharge_counts";
    }
    /**
     * 付费次数统计
     * @param channelNames
     ...
     * @return
     */
    @PostMapping("/stat_recharge_counts")
    @ResponseBody
