...
public class LimitedTotalConsume extends Activity implements IActivityCustom {
    ...
    public Activity parseCustom(Map<String, String[]> paramMap) {
        ...
        String[] coinType = paramMap.get("coinType");   //Тип валюты
        ...
        for (int i = 0; i < i_reach.length; i++) {
            ...
            map.put("targetConsume", target);            // 消耗Сумма
            ...
            map.put("customRewardMap", ItemBean.split(i_SelectRewardGroup[i])); //可选择Группа наград
