package com.gm.project.system.user.controller;
...
import com.gm.common.utils.CookieUtils;
...
public class IndexController extends BaseController
{
    ...
    public String index(ModelMap mmap)
    {
        ...
        mmap.put("copyrightYear", gameManagerConfig.getCopyrightYear());
        mmap.put("demoEnabled", gameManagerConfig.isDemoEnabled());
    ...
    {
        mmap.put("version", gameManagerConfig.getVersion());
        return "main";
    }
