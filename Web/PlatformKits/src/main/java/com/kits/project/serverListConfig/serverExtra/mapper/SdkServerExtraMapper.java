package com.kits.project.serverListConfig.serverExtra.mapper;
 ...
 * @date 2021-05-07
 */
public interface SdkServerExtraMapper
{
    /**
     * 查询服务器额外信息
     *
     ...
     * 批量删除服务器额外信息
     *
     * @param serverListIds 需要删除的数据ID
     * @return 结果
     */
    public int deleteSdkServerExtraByIds(String[] serverListIds);
    ...
    /**
     * 根据服务器列表ID和服务器ID获取服务器额外信息
     * @param paramMap
     * @return
     */
    public List<SdkServerExtra> selectSdkServerExtraByServerListIdAndServerId(Map paramMap);
