package com.kits.project.monitor.job.controller;
...
import com.kits.common.exception.job.TaskException;
...
import com.kits.project.monitor.job.domain.Job;
import com.kits.project.monitor.job.service.IJobService;
import com.kits.project.monitor.job.util.CronUtils;
...
public class JobController extends BaseController
{
    ...
    {
        if (!CronUtils.isValid(CronUtils.parseTime(job.getCronExpression())))
        {
    ...
    {
        return jobService.checkCronExpressionIsValid(CronUtils.parseTime(job.getCronExpression()));
    }
}
