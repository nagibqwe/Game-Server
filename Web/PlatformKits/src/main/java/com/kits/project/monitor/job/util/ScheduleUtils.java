package com.kits.project.monitor.job.util;
...
import com.kits.common.constant.ScheduleConstants;
import com.kits.common.exception.job.TaskException;
import com.kits.common.exception.job.TaskException.Code;
...
public class ScheduleUtils
{
    ...
    public static void createScheduleJob(Scheduler scheduler, Job job) throws SchedulerException, TaskException
    {
        ...
        // 表达式调度构建器
        CronScheduleBuilder cronScheduleBuilder = CronScheduleBuilder.cronSchedule(CronUtils.parseTime(job.getCronExpression()));
