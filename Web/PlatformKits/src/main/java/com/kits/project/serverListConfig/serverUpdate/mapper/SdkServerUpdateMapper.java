package com.kits.project.serverListConfig.serverUpdate.mapper;
 ...
 * @date 2021-12-08
 */
public interface SdkServerUpdateMapper 
{
    /**
     * 查询服务器信息修改时间记录
     * 
     ...
     * 批量删除服务器信息修改时间记录
     * 
     * @param updateTimes 需要删除的数据ID
     * @return 结果
     */
    public int deleteSdkServerUpdateByIds(String[] updateTimes);
}
