...
public class Cfg_HuaxingTalisman_Bean{
    /**
     * 模型ID
     */
    ...
    public Cfg_HuaxingTalisman_Bean(int id,String name,int camera_size,int active_item,String rent_attStr,String star_itemnumStr){
        this.id = id;
        this.name = name;
