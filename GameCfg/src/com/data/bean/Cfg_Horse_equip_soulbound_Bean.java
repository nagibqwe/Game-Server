...
public class Cfg_Horse_equip_soulbound_Bean{
    /**
     * 流水号
...
脉轮*100000000+部位*10000 +附魂等级
     ...
     */
    private final ReadIntegerArrayEs PercentValue;
    /**
     * 百分比属性加成

     * @return
     */
    public final ReadIntegerArrayEs getPercentValue(){
        return PercentValue;
    }
    /**
     * 附魂增加的属性
    ...
    public Cfg_Horse_equip_soulbound_Bean(int Id,int site,int Type,int Level,String ConsumeStr,String PercentValueStr,String ExtraValueStr){
        this.Id = Id;
        this.site = site;
        this.Type = Type;
        this.Level = Level;
        this.Consume = new ReadIntegerArrayEs(ConsumeStr,"}",",");
        this.PercentValue = new ReadIntegerArrayEs(PercentValueStr,"}",",");
