...
public class Cfg_Pet_equip_synthesis_Bean{
    /**
     * 身上穿的装备ID
     */
...
宠物没有阶的概念
    ...
    public Cfg_Pet_equip_synthesis_Bean(int Id,int Equip_ID,int synthesis_level,String join_partStr,int professional,String qualityStr,String quality_NumberStr,int join_num_probability,String diamondStr,String diamond_NumberStr,String join_itemStr,String item_PriceStr,String join_EquipID1Str,String join_num1Str,String join_EquipID2Str,String join_num2Str,String failure_typeStr,int notice,String chatchannelStr){
        this.Id = Id;
