...
public class Cfg_HuaxingWeapon_Bean{
    /**
     * 模型ID
     */
    ...
    public Cfg_HuaxingWeapon_Bean(int id,String name,int order,int if_fashion,int active_condition,int active_item,String rent_attStr,String star_itemnumStr,int Passive_skill){
        this.id = id;
        this.name = name;
        this.order = order;
