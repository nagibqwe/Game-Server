...
public class Cfg_NatureTalisman_Bean{
    /**
     * 法器等级
     */
    ...
    public Cfg_NatureTalisman_Bean(int id,String name,int progress,int last_exp,String attributeStr,String skillStr,String up_itemStr,int ModelID,int camera_size){
        this.id = id;
        this.name = name;
