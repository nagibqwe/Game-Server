...
public class Cfg_NatureMagic_Bean{
    /**
     * 阵法等级
     */
    ...
    public Cfg_NatureMagic_Bean(int id,String name,int progress,int last_exp,String attributeStr,String skillStr,String up_itemStr,int ModelID,int camera_size){
        this.id = id;
        this.name = name;
