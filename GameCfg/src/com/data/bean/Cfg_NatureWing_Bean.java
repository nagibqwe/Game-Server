...
public class Cfg_NatureWing_Bean{
    /**
     * 翅膀等级
     */
    ...
    public Cfg_NatureWing_Bean(int id,String name,int progress,int last_exp,String attributeStr,String skillStr,String up_itemStr,int ModelID,int camera_size){
        this.id = id;
        this.name = name;
