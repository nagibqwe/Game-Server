...
public class Cfg_Bossnew_SoulBeasts_Bean{
    /**
     * 编号ID
     */
    ...
    public Cfg_Bossnew_SoulBeasts_Bean(int ID,String monster_name,int canShow,int crossSever,int type,int monsterid,int enterLevel,int bossLevel,int layer,int cloneid,int num,String posStr,int initial_time,int standard_time,int float_time,String limit_timeStr,String increase_timeStr,int if_raward){
        this.ID = ID;
