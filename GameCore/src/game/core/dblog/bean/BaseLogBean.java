...
public abstract class BaseLogBean {
    ...
    protected static final Logger logger = LogManager.getLogger(BaseLogBean.class);
    //字段DDL信息 用于建表
    ...
    public BaseLogBean() {
        ...
        if (!metadataset.containsKey(getClass())) {
            ...
            for (Method method : declaredMethods) {
                ...
                if (annotation != null) {
                    if (is4399Log() && annotation.logField().equals("time")) {
                        continue;
                    }
...
//		case UNROLL:
    ...
    private boolean is4399Log() {
        String prefix = "tbllog_";
        String tableName = getTableName();
