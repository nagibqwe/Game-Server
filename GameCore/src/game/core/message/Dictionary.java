...
public class Dictionary
{
     ...
     *
     * @param message 消息类型
     * @param handlerInstance 消息对应的处理函数类型
     * @throws java.lang.InstantiationException
     * @throws java.lang.IllegalAccessException
     */
    public Dictionary(
            Class<? extends GeneratedMessage> message,
            Class<? extends Handler> handlerInstance) throws InstantiationException, IllegalAccessException
    {
        this.message = message;
        this.handler = handlerInstance.newInstance();
    }
